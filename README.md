...
در همهٔ گزینه‌ها **مغز و صدای فارسی از سرور شماست**؛ سرویس آواتار فقط چهره و حرکت لب را می‌سازد (عامل‌های آمادهٔ این سرویس‌ها فارسی را خوب نمی‌فهمند و استفاده نمی‌شوند).
...
| گذرواژهٔ مدیر فراموش شد | — | روی سرور: `npm run admin:create` با همان ایمیل |
